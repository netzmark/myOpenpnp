...
//        panel_1.add(newFeederBtn);
        ...
        whateverPanel.add(lblRetryCount, "2, 10, right, default");
       
        retryCount = new JTextField();
        whateverPanel.add(retryCount, "4, 10");
        retryCount.setColumns(10);
        
        JLabel lblAlignRetryCount = new JLabel("Align Retry Count");
        whateverPanel.add(lblAlignRetryCount, "6, 10, right, default");

        alignRetryCount = new JTextField();
        alignRetryCount.setText("2");
        whateverPanel.add(alignRetryCount, "8, 10, fill, default");
        alignRetryCount.setColumns(2);
...
///////////////////
        ...
        whateverPanel.add(chckbxAutoSkipAlign, "10, 12, right, default");
        
        JLabel lblAutoSkipAlign = new JLabel("AutoSkip on Align Error");
        whateverPanel.add(lblAutoSkipAlign, "12, 12, left, default"); 
        
        chckbxAutoSkipPick = new JCheckBox("");
        whateverPanel.add(chckbxAutoSkipPick, "10, 10, right, default");
        
        JLabel lblAutoSkipPick = new JLabel("AutoSkip on Feed/Pick Error");
        whateverPanel.add(lblAutoSkipPick, "12, 10, left, default"); 
        
        lblRetryCount.setToolTipText("The number of Feeds to retry. <0> means just single Feeding with no retries.");
        retryCount.setToolTipText("The number of Feeds to retry. <0> means just single Feeding with no retries.");      
        lblAlignRetryCount.setToolTipText("The number of Aligns (with Picks) to retry. <0> means just single Alignment with no retries.");
        alignRetryCount.setToolTipText("The number of Aligns (with Picks) to retry. <0> means just single Alignment with no retries.");      
        lblPickRetryCount.setToolTipText("The number of Picks to retry. <0> means just single Picking with no retries.");
        pickRetryCount.setToolTipText("The number of Picks to retry. <0> is deafult and means single Picking with no retries.");
...
//        retryCount.setColumns(10);
    ...
    public void createBindings() {
        ...
        addWrappedBinding(feeder, "retryCount", retryCount, "text", intConverter);
        addWrappedBinding(feeder, "alignRetryCount", alignRetryCount, "text", intConverter);
        ...
        ComponentDecorators.decorateWithAutoSelect(retryCount);
        ComponentDecorators.decorateWithAutoSelect(alignRetryCount);
...
*/
    ...
    private JTextField retryCount; //feedRetryCount in 2.0
    private JTextField pickRetryCount;
    private JTextField alignRetryCount;
